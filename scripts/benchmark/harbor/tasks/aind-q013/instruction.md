...
> Which unique brain structures were targeted across the SmartSPIM (`SPIM`) assets in the `Thalamus in the middle` project that were acquired before 2024-01-01?
