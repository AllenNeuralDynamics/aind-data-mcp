...
> Which unique actual viral material names were injected into subjects in the `Thalamus in the middle` project for assets acquired before 2024-01-01? Exclude schema-upgrade placeholder values that do not identify a material.
